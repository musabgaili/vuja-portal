...
<div class="row g-3">
    ...
    <div class="col-lg-5">
        <div class="card"><div class="card-content">
            @if($quote->isAccepted())
                <div class="alert alert-success mb-0" data-persist><i class="fas fa-circle-check"></i> {{ __('portal.quote.you_accepted') }} {{ optional($quote->accepted_at)->translatedFormat('M j, Y') }}.<br><small>{{ __('portal.quote.signed_by') }}: {{ $quote->accepted_signature }}</small></div>
