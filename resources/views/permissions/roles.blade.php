...
<div class="card">
    ...
    <div class="card-content">
        <div class="roles-grid">
            ...
            <div class="role-card" style="border-left-color: {{ $role->name === 'manager' ? '#f59e0b' : ($role->name === 'employee' ? '#0C7075' : ($role->name === 'client' ? '#3b82f6' : '#0C7075')) }};">
...
.role-badge-employee { background: #0C7075; color: white; padding: 4px 12px; border-radius: 4px; font-size: 12px; }
