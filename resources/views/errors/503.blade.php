...
<head>
    ...
    <title>{{ __('errors.title_503') }} - VujaDe</title>
    ...
    <main class="min-vh-100 d-flex align-items-center justify-content-center p-4">
        <div class="card border-0 shadow-sm text-center" style="max-width: 520px;">
            <div class="card-body p-5">
                <h1 class="display-4 fw-bold text-secondary">503</h1>
                <h2 class="h4 mb-3">{{ __('errors.title_503') }}</h2>
                <p class="text-muted">{{ __('errors.message_503') }}</p>
