...
<div class="card">
    ...
    <div class="card-content">
        ...
        @forelse($threed->files as $f)
            <a href="{{ route('threed.files.download', $f) }}" class="d-inline-flex align-items-center gap-2 me-2 mb-2 badge bg-body-secondary text-body border" style="text-decoration:none;">
