...
<head>
    ...
    <style>
        ...
        .header{text-align:center;padding-bottom:20px;border-bottom:2px solid #0F969C;}
        .header h1{color:#0F969C;margin:0;}
        .content{padding:20px 0;}
        .credentials{background:#f8f9fa;padding:15px;border-radius:5px;margin:20px 0;}
        .credentials p{margin:5px 0;}
        .btn{display:inline-block;padding:12px 24px;background:#0F969C;color:#fff;text-decoration:none;border-radius:5px;margin:20px 0;}
