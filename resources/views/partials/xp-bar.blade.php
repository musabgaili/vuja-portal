...
<a href="{{ route('engagement.index') }}" class="xp-chip" title="{{ $ipLevelName }} · {{ number_format($ipUser->impact_points) }} {{ __('portal.engagement.ip') }} — {{ __('portal.engagement.ip_tooltip') }}">
